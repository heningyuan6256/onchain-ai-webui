...
import RetractSvg from "../../assets/image/front-retract.svg";
    ...
    <SidebarContext.Provider value={contextValue}>
      <TooltipProvider delayDuration={0}>
        <div
          ...
          className={cn(
            "group/sidebar-wrapper has-data-[variant=inset]:bg-sidebar flex min-h-svh w-full h-svh",
            className
          )}
          {...props}
        >
    ...
    if (open) {
      ...
      return (
        <Button
          ...
          {...props}
        >
          <Icon className="cursor-pointer" src={RetractSvg}></Icon>
        </Button>
      );
    }
  }
...
function SidebarGroup({ className, ...props }: React.ComponentProps<"div">) {
  ...
  return (
    <div
      ...
      data-sidebar="group"
      className={cn(`relative flex w-full min-w-0 flex-col ${open ? "px-1" : "p-2"}`, className)}
      {...props}
    />
  );
}
...
function SidebarMenuButton({
  ...
  const button = (
    <Comp
      ...
      className={cn(sidebarMenuButtonVariants({ variant, size }), "px-4", className)}
      {...props}
    />
  );
...
function SidebarMenuHorizentol({ className, ...props }: React.ComponentProps<"div">) {
  return <div className={cn("w-full", className)} style={{ height: "1px", background: "#D0D0D0" }} {...props}></div>;
}
          ...
          return (
            ...
            >
              ...
              >
                ...
                <div className="overflow-ellipsis w-full overflow-hidden">{item.name}</div>
              </div>
            </motion.div>
          );
        })}
...
function SidebarMenuTitleItem({
  ...
  return (
    <div className={cn("w-full", className)} style={{ height: "1px", background: "#D0D0D0" }} {...props}>
      {props.title}
    </div>
  );
}
