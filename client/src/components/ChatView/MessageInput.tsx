...
export default function MessageInput({
  ...
  return (
    <div
      ...
      } flex justify-center mx-auto px-4 py-4 sm:w-[60%] 2xl:w-[50%] max-w-3xl`}
    >
      <form onSubmit={onSubmit} className="w-full">
        <div
          className={`relative flex items-center rounded-2xl shadow-lg ${
            isDarkMode
            ...
            <div ref={dropdownRef} className="relative">
              ...
              {showBotDropdown && (
                <div
                  ...
                  } right-0 w-48 rounded-md shadow-lg ${
