...
export const defaultTextProps =
  'rounded-md border border-gray-200  bg-transparent text-sm shadow-[0_0_10px_rgba(0,0,0,0.05)] outline-none   placeholder:text-text-secondary   disabled:cursor-not-allowed disabled:opacity-50 dark:bg-gray-700 dark:border-gray-600   dark:text-gray-50 dark:shadow-[0_0_15px_rgba(0,0,0,0.10)] ';
