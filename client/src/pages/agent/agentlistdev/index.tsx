                      ...
                      >
                        ...
                        <div>
                          <div className="flex justify-between">
                            ...
                            <div className="agentvalue h-6 w-[calc(20%)]">已发布</div>
                          </div>
                          <div className="flex justify-between">
                            <div className="agentobj h-6 w-[calc(25%)]">更新时间</div>
                            <div className="agentvalue h-6 w-[calc(30%)]">2025.88.88</div>
                            <div className="agentobj h-6 w-[calc(20%)]">创建人</div>
                            <div className="agentvalue h-6 w-[calc(20%)]">郑工</div>
                          </div>
                        </div>
                      </motion.div>
                    </Col>
                  ...
                  {publislist.map((app, idx) => (
                    <Col key={idx} xs={14} sm={12} md={12} lg={10} xl={8} xxl={6}>
                      ...
                      >
                        ...
                        >
                          <Icon
                            src={app.collect ? wishlisted : collect}
