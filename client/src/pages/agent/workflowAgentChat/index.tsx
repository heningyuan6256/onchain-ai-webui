...
import WorkflowAgentChatView from '~/components/Chat/WorkflowAgentChatView';
...
export default function AgentChat() {
  ...
  useEffect(() => {
    if (location.pathname.startsWith('/agentconfig/')) {
      ...
      // setIsTemporary(true);//一改会改全局，这个得后面再看
    } else if (conversationId !== Constants.NEW_CONVO && !isTemporaryChat) {
      setIsTemporary(false);
  ...
  return (
    <ToolCallsMapProvider conversationId={conversation.conversationId ?? ''}>
      <WorkflowAgentChatView index={index} />
