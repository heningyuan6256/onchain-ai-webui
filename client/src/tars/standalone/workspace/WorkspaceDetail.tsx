...
import { ChatCompletionContentPart, ChatCompletionContentPartImage } from "@multimodal/agent-interface";
...
export const WorkspaceDetail: React.FC = () => {
          ...
          return [
            {
              ...
              data: source,
              tool: title,
              query: activePanelContent.arguments.data,
            },
          ];
        }
  ...
  return (
    <motion.div
      ...
      animate={{ opacity: 1 }}
      exit={{ opacity: 0 }}
      className="h-full flex flex-col bg-[#F4F4F5] dark:bg-[#F4F4F5]"
    >
