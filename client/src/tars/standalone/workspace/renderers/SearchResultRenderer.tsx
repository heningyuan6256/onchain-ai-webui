      ...
      {query && (
        <div className="mb-5">
          <div className="flex items-center mb-4">
            ...
            <div>
              <h3 className="text-xl font-medium text-gray-800 dark:text-gray-200">搜索结果</h3>
              <p className="text-sm text-gray-500 dark:text-gray-400">查询到 {results.length} 相关结果</p>
            </div>
          </div>
                ...
                <div className="flex items-start">
                  <div className="min-w-0 flex-1">
                    ...
                    <a href={result.url} target="_blank" rel="noopener noreferrer" className="group/link">
                      <h3 className="font-medium text-gray-800 dark:text-gray-200 mb-2 flex items-center hover:text-accent-600 dark:hover:text-accent-400 transition-colors text-sm">
                        <span className="mr-2">
