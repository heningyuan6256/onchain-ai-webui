    ...
    <div className="space-y-4">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200/50 dark:border-gray-700/30 shadow-sm overflow-hidden">
        <div className="px-4 py-3 bg-gray-50/80 dark:bg-gray-800/80 border-b border-gray-100/50 dark:border-gray-700/30 flex items-center">
          ...
          <div className="font-sm text-gray-700 dark:text-gray-300">远程桌面操作</div>
          {status && (
            <div
        ...
        <div className="p-4 space-y-3">
          ...
          {thought && (
            <div className="space-y-1">
              ...
              <div className="text-xs text-gray-600 dark:text-gray-400 pl-6 border-l-2 border-accent-100 dark:border-accent-900/30">
                {thought}
              </div>
            </div>
          )}
          ...
          {step && (
            <div className="space-y-1">
              <div className="flex items-center text-sm font-xs text-gray-700 dark:text-gray-300">
                <FiChevronsRight
              ...
              <div className="text-xs text-gray-600 dark:text-gray-400 pl-6 border-l-2 border-primary-100 dark:border-primary-900/30">
                {step}
              </div>
            </div>
          )}
