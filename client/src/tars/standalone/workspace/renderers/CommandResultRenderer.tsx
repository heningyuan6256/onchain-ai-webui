  ...
  return (
    <div className="space-y-2 h-full">
      <div className="mb-2 h-full">
        {/* Terminal interface */}
        <div className="rounded-lg overflow-hidden border border-gray-900 h-full flex flex-col">
          {/* Terminal title bar */}
          ...
          <div className="bg-black p-2 font-mono text-xs terminal-content overflow-auto max-h-full flex-1">
